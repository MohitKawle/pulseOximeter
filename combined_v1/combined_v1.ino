...
const int buzpin = 9;  // buzzer pin on pin no 9
...
void loop()
{
  ...
  display.setCursor(10, 1); //--> (x position, y position)
  display.println(gasPin);
  display.display(); 
  delay(2000);
  //----------------------------------------
  ...
  //smoke sensor processing end
  
//--------------------------------------------------------------------------------------------------------------------------------------------------   
  
  // dht 11 processing start
